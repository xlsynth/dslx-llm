...
CODE_GENERATOR = os.environ.get('CODE_GENERATOR', 'openai')
CodeGenerator = importlib.import_module(f'codegenerator.{CODE_GENERATOR}').CodeGenerator
...
def main() -> None:
    ...
    parser.add_option('--model', default=None, choices=CodeGenerator.MODEL_CHOICES, help='choose a model to query; choices: %s' % '|'.join(CodeGenerator.MODEL_CHOICES))
